...
- [Tải sơ đồ Use Case Quản lý Lưu trú](file:///c:/Users/ADMIN/Desktop/DaiNamNew/docs/Sprint1/09_UseCase_LuuTru_v1.0.html)
- [Xem luồng Activity Diagram](file:///c:/Users/ADMIN/Desktop/DaiNamNew/activity_diagrams1.html)
...
- [Tham chiếu sơ đồ Use Case Quản lý Lưu Trú](file:///c:/Users/ADMIN/Desktop/DaiNamNew/docs/Sprint1/09_UseCase_LuuTru_v1.0.html)
...
## 2.1. Truy vấn dữ liệu doanh thu tổng hợp
...
### 2.1.3. Biểu đồ use-case / Activity Diagram
...
### 2.1.4. Luồng thao tác

#### 2.1.4.1. Tình huống 1 — Luồng chuẩn (Happy Path)
...
#### 2.1.4.2. Tình huống 2 — Khoảng thời gian không hợp lệ
| | Nhân viên kế toán | Hệ thống |
|---|---|---|
...
#### 2.1.5.1. Bảng thuộc tính các trường dữ liệu (Field Description Table)
| STT | Tên trường | Control type | Required | Data type | Default value | Mô tả |
|---|---|---|---|---|---|---|
...
### 2.2.3. Biểu đồ use-case / Activity Diagram
- [Tải sơ đồ Use Case](file:///c:/Users/ADMIN/Desktop/DaiNamNew/docs/Sprint1/08_UseCase_BaoCaoDoanhThu_v1.0.html)
- [Xem luồng Activity Diagram](file:///c:/Users/ADMIN/Desktop/DaiNamNew/activity_diagrams.html)

#### 2.2.3.1. Tiền điều kiện
- Lưới đã được nạp dữ liệu thành công từ use-case 1.1.

#### 2.2.3.2. Hậu điều kiện
- Bố cục lưới thay đổi tương ứng với cấu hình người dùng vừa thiết lập.

#### 2.2.3.3. Điểm kích hoạt
Người dùng kéo thả tiêu đề cột trên giao diện lưới.

### 2.2.4. Luồng thao tác

#### 2.2.4.1. Tình huống 1 — Phân tích doanh thu theo Nhân viên thu ngân
| | Nhân viên kế toán | Hệ thống |
|---|---|---|
...
#### 2.2.5.1. Bảng dữ liệu Pivot Grid (Read-only)
...
### 2.3.3. Biểu đồ use-case / Activity Diagram
- [Tải sơ đồ Use Case](file:///c:/Users/ADMIN/Desktop/DaiNamNew/docs/Sprint1/08_UseCase_BaoCaoDoanhThu_v1.0.html)
- [Xem luồng Activity Diagram](file:///c:/Users/ADMIN/Desktop/DaiNamNew/activity_diagrams.html)

#### 2.3.3.1. Tiền điều kiện
- Báo cáo đang có dữ liệu hiển thị.

#### 2.3.3.2. Hậu điều kiện
- File Excel được lưu thành công xuống ổ đĩa máy tính.

#### 2.3.3.3. Điểm kích hoạt
Người dùng bấm nút Xuất Excel.

### 2.3.4. Luồng thao tác

#### 2.3.4.1. Tình huống 1 — Xuất file thành công
| | Nhân viên kế toán | Hệ thống |
|---|---|---|
