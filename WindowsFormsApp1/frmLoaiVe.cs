...
namespace WindowsFormsApp1
{
    public partial class frmLoaiVe : Form
    {
        ...
        {
            // Trạng thái — hardcode theo DB CHECK: 'Hoạt động', 'Ngừng bán'
            cboTrangThai.DataSource = new List<string> { "Hoạt động", "Ngừng bán" };

            // Đối tượng — hardcode theo nghiệp vụ
        ...
        private void dgvLoaiVe_Click(object sender, EventArgs e)
        {
            ...
            // Load chi tiết combo nếu là combo
        ...
        {
            // Kiểm tra đã lưu loại vé combo chưa (phải có MaLoaiVe)
