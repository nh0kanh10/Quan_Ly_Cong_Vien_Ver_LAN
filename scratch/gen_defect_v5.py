...
actual_results_map = {
    ...
    'TC_PQ_033': 'Hệ thống im lặng dừng tải quyền mà không thông báo lỗi mạng cho người dùng biết (do chặn bằng if !Success return).',
...
print(f'Successfully wrote {len(output_rows)} defects.')
