        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            for row in reader:
                ...
                if tc_id in tc_list:
                    ...
                    actual = actual_results_map.get(tc_id, 'Hệ thống lỗi không đúng mong muốn.')
                    severity = 'High' if 'Exception' in actual or 'treo' in actual or 'âm' in actual else 'Medium'
...
print(f'Successfully wrote {len(output_rows)} defects with exact requested format.')
