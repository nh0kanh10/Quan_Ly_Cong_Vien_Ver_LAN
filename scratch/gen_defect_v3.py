...
def generate_actual_steps(expected_text, failure_msg):
    ...
    # Replace the text of the last step with the failure message
    # e.g. "Bước 6. Hệ thống báo lỗi abc." -> "Bước 6. " + failure_msg
...
print(f'Successfully wrote {len(output_rows)} defects with step-by-step actual results.')
